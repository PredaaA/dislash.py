...
class ClickListener:
    ...
    def __init__(self, message_id: int, timeout: float = 0):
        ...
        self._listeners: List[
            Tuple[
                Callable[[MessageInteraction], Awaitable[Any]],
                Callable[[MessageInteraction], bool],
                bool,
                bool,
            ]
        ] = []
    ...
    def matching_condition(
        self,
        check: Callable[[MessageInteraction], bool],
        *,
    ...
    def from_user(
        self, user: discord.User, *, cancel_others: bool = False, reset_timeout: bool = True
    ):
        """
        A decorator that makes the function below waiting for a click
        ...
        return self.matching_condition(
            is_user, cancel_others=cancel_others, reset_timeout=reset_timeout
        )
    ...
    def not_from_user(
        ...
        return self.matching_condition(
            is_not_user, cancel_others=cancel_others, reset_timeout=reset_timeout
        )
    ...
    def no_checks(self, *, cancel_others: bool = False, reset_timeout: bool = True):
        ...
        return self.matching_condition(
            always, cancel_others=cancel_others, reset_timeout=reset_timeout
        )

    def matching_id(
        self, custom_id: str, *, cancel_others: bool = False, reset_timeout: bool = True
    ):
        """
        A decorator that makes the function below waiting for a click
        ...
        return self.matching_condition(
            check, cancel_others=cancel_others, reset_timeout=reset_timeout
        )
